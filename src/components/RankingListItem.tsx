...
export default function RankingListItem({ index, person } : RankingListItemProps) {
  return (
    <li className='from-black-to-transparent px-5 p-2 mb-2 flex justify-between items-center list-item-container text-white box-border border-secondary-black border blur-md rounded-md'>
